...
##? Serializer Import 
from apis.v1.attributes.serializers.ItemSerializer import ItemSerializer, MiniItemSerializer

"""
##TODO:- Item Create & List API Views
...
class ItemListCreateAPIView(generics.ListCreateAPIView): 
    ...
    def get_permissions(self):
        if self.request.method == "POST":
            self.required_perms = ["product.add_Item"]
        else:
    ...
    def get_queryset(self):
        ...
        return queries.ItemQueryService.get_queryset(search=search)
