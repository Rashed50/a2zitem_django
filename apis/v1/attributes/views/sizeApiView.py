...
"""
##TODO:- Size Create & List API Views
...
class SizeListCreateAPIView(generics.ListCreateAPIView): 
    ...
    def get_permissions(self):
        if self.request.method == "POST":
            self.required_perms = ["product.add_size"]
        else:
            self.required_perms = ["product.view_size"]
        return super().get_permissions() 
    
    # ##? Queryset
    def get_queryset(self):
        search = self.request.query_params.get("search")
        return queries.SizeQueryService.get_queryset(search=search)
    ...
    def create(self, request, *args, **kwargs): 
        ...
        return response_create(serializer.data,item_name="Size") 
...
"""
##TODO:- Size Retrieve, Update, Destroy API Views
...
class SizeRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView): 
    ...
    def get_permissions(self):
        if self.request.method == "PUT":
            self.required_perms = ["product.change_size"]
        elif self.request.method == "PATCH":
            self.required_perms = ["product.change_size"]
        elif self.request.method == "DELETE":
            self.required_perms = ["product.delete_size"]
        else:
            self.required_perms = ["product.view_size"]
        return super().get_permissions()
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        return response_details(serializer.data, item_name="Size")
    ...
    def update(self, request, *args, **kwargs): 
        ...
        return response_update(serializer.data, serializer=serializer, item_name='Size')
    ...
    def destroy(self, request, *args, **kwargs): 
        ...
        return response_delete(item=instance, item_name='Size', request=request)
