...
"""
##TODO:- Brand Create & List API Views
...
class BrandListCreateAPIView(generics.ListCreateAPIView): 
    ...
    def get_permissions(self):
        if self.request.method == "POST":
            self.required_perms = ["product.add_brand"]
        else:
            self.required_perms = ["product.view_brand"]
        return super().get_permissions() 
    
    # ##? Queryset
    def get_queryset(self):
        search = self.request.query_params.get("search")
        return queries.BrandQueryService.get_queryset(search=search)
    ...
    def create(self, request, *args, **kwargs): 
        ...
        return response_create(serializer.data,item_name="Brand") 
...
"""
##TODO:- Brand Retrieve, Update, Destroy API Views
...
class BrandRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView): 
    ...
    def get_permissions(self):
        if self.request.method == "PUT":
            self.required_perms = ["product.change_brand"]
        elif self.request.method == "PATCH":
            self.required_perms = ["product.change_brand"]
        elif self.request.method == "DELETE":
            self.required_perms = ["product.delete_brand"]
        else:
            self.required_perms = ["product.view_brand"]
        return super().get_permissions()
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        return response_details(serializer.data, item_name="Brand")
    ...
    def update(self, request, *args, **kwargs): 
        ...
        return response_update(serializer.data, serializer=serializer, item_name='Brand')
    ...
    def destroy(self, request, *args, **kwargs): 
        ...
        return response_delete(item=instance, item_name='Brand', request=request)
